...
document.getElementById('tinhTienCapBtn').onclick = function (event) {
    ...
    if (!soTaiKhoan.value ||
        ...
        soKenh.value.includes(',') ||
        soDauNoi.value.includes(',')) {
        alert('Xin mời điền đầy đủ thông tin. Số đầu nối và số kênh phải là số nguyên dương.')
    } else {
        var tienCap;
        // Tiền Thuế Cao Cấp của Nhà Dân
        ...
        //Tiền Thuế Cao Cấp Doanh Nghiệp
        ...
        //Tiền Dịch vụ cơ bản Doanh Nghiệp
